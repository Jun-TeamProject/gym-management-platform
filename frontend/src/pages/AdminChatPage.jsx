...
const AdminChatPage = () => {
    ...
    if (loading) return <div className="p-6 text-center">채팅방 목록 로딩 중...</div>;
            ...
            <div className="flex w-full rounded-xl shadow-2xl overflow-hidden bg-white">
                ...
                <div className="flex-none w-80 border-r border-gray-200 flex flex-col">
                    <div className="p-4 border-b">
                        <h3 className="text-lg font-semibold text-gray-800">활성 채팅 ({chatRooms.length})</h3>
                    </div>
                        ...
                        {chatRooms.map(room => (
                            <div
                                ...
                                className={`p-4 cursor-pointer hover:bg-indigo-50 transition duration-150 
                                            ${selectedRoom?.id === room.id ? 'bg-indigo-100 border-l-4 border-indigo-600' : ''}`}
                            >
                        ...
                        <>
                            ...
                            <div className="p-4 border-t bg-white flex">
                                ...
                                <button
                                    ...
                                    disabled={!isConnected}
                                    className={`ml-2 rounded-xl text-white px-4 py-1 flex-shrink-0 transition duration-300 ${isConnected ? 'bg-indigo-500 hover:bg-indigo-600' : 'bg-gray-400 cursor-not-allowed'}`}
                                >
                                    전송
                                </button>
                            </div>
